        ...
        <div className='container'>
          <div className='content_holder max450'>
            <div className='title_holder'>
              ...
              <p>
                We are committed to providing the highest level of professionalism, service
                response, personalised solutions, competitive prices, professional and qualified,
                integrated design and quality workmanship.
              </p>
            </div>
            <div className='btn_holder fn_cs_lightgallery'>
              <Link href='/services' className='discover' onClick={() => setIsOpen(true)}>
