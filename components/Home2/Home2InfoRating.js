          ...
          <div className='inner'>
            <div className='left_part'>
              <div className='title_holder'>
                ...
                <p className='l_desc'>
                  To further develop our corporate strengths we have established a corporate mandate
                  to maintain strong core values that truly reflect the companys philosophy.
                </p>
              </div>
              <div className='l_video fn_cs_lightgallery' onClick={() => setIsOpen(true)}>
