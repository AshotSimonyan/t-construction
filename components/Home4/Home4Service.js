            ...
            <ul>
              <li>
                <div className='item'>
                  ...
                  <p>
                    During this phase, we will work to provide a detailed analysis of the project
                    and we will establish project expectations along with our clients.
                  </p>
              ...
              <li>
                <div className='item'>
                  ...
                  <p>
                    ...
                    the necessary drawings and specifications for new project.
                  </p>
              ...
              <li>
                <div className='item'>
                  ...
                  <p>
                    Under a Construction Management contract, the client secures the services of a
                    construction manager to work with the design team.
                  </p>
                  <span className='more_details'>
                    <Link href='#'>
                      More Details
              ...
              <li>
                <div className='item'>
                  ...
                  <h3>Design-Build</h3>
                  <p>
                    In this section, we let clients select a design-build arrangement when they want
                    to work with one contract entity, instead of several contractors and
                    consultants.
                  </p>
                  <span className='more_details'>
                    <Link href='#'>
