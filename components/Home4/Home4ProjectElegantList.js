                ...
                <div className='item_wrapper'>
                  <div className='item'>
                    <div className='img_holder'>
                      ...
                      <div
                        className='abs_img'
                        style={{ backgroundImage: 'url(/img/project-elegant/1.jpg)' }}
                      >
                ...
                <div className='item_wrapper'>
                  <div className='item'>
                    <div className='img_holder'>
                      ...
                      <div
                        className='abs_img'
                        style={{ backgroundImage: 'url(/img/project-elegant/2.jpg)' }}
                      >
                ...
                <div className='item_wrapper'>
                  <div className='item'>
                    <div className='img_holder'>
                      ...
                      <div
                        className='abs_img'
                        style={{ backgroundImage: 'url(/img/project-elegant/3.jpg' }}
                      >
              ...
              <div className='item_wrapper'>
                <div className='item'>
                  <div className='img_holder'>
                    ...
                    <div
                      className='abs_img'
                      style={{ backgroundImage: 'url(/img/project-elegant/4.jpg' }}
                    >
                  ...
                  <div className='title_holder'>
                    <p>Aerospace</p>
                    <h3>
                      <Link href='/portfolioSinglePage4'>Arturo-Merino-Benítez</Link>
                    </h3>
                  </div>
                </div>
              </div>
              <div className='item_wrapper'>
                <div className='item'>
                  <div className='img_holder'>
                    ...
                    <div
                      className='abs_img'
                      style={{ backgroundImage: 'url(/img/project-elegant/5.jpg' }}
                    >
                  ...
                  <div className='title_holder'>
                    <p>Construction</p>
                    <h3>
                      <Link href='/portfolioSinglePage5'>Femern Tunnel, Germany-Denmark</Link>
                    </h3>
                  </div>
                </div>
              </div>
              <div className='item_wrapper'>
                <div className='item'>
                  <div className='img_holder'>
                    ...
                    <div
                      className='abs_img'
                      style={{ backgroundImage: 'url(/img/project-elegant/6.jpg' }}
                    >
                  ...
                  <div className='title_holder'>
                    <p>Construction</p>
                    <h3>
                      <Link href='/portfolioSinglePage6'>Meliá Hotel La Défense</Link>
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <div className='item_wrapper'>
                  <div className='item'>
                    <div className='img_holder'>
                      ...
                      <div
                        className='abs_img'
                        style={{ backgroundImage: 'url(/img/project-elegant/7.jpg)' }}
                      >
                ...
                <div className='item_wrapper'>
                  <div className='item'>
                    <div className='img_holder'>
                      ...
                      <div
                        className='abs_img'
                        style={{ backgroundImage: 'url(/img/project-elegant/8.jpg)' }}
                      >
                    ...
                    <div className='title_holder'>
                      <p>Construction</p>
                      <h3>
                        <Link href='/portfolioSinglePage8'>Mandarin Oriental</Link>
                      </h3>
                    </div>
                  </div>
                </div>
                <div className='item_wrapper'>
                  <div className='item'>
                    <div className='img_holder'>
                      ...
                      <div
                        className='abs_img'
                        style={{ backgroundImage: 'url(/img/project-elegant/9.jpg)' }}
                      >
        ...
        <div className='fn_cs_description' data-margin-bottom='43'>
          <div className='container max1500'>
            <div className='desc_holder'>
              <p>
                It’s about time for a live page builder, with no limits of design. A page builder
                that delivers high-end page designs and advanced capabilities, never before seen on
                WordPress. These floods develop as a result of rainfall events that are at or near
                the yearly maximum.
              </p>
            </div>
          </div>
