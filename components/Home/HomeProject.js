        ...
        <div className='inner'>
          <div className='left_part'>
            <div className='fn_cs_sticky_section'>
              ...
              <p>
                At Industify Company, we rely on honesty, discipline and hard work and believe our
                success can be attributed to upholding a simple set of core values that date back to
                the beginning of the company.
              </p>
              <p>
                Industify is an integrated design-build firm offering engineering, architecture and
                construction services to domestic and international customers throughout the U.S.
                Unique to Industify is the fact that we conduct all disciplines in-house in a
                ...
                <li>
                  <div className='item'>
                    ...
                    <div className='title_holder'>
                      ...
                      <span className='desc'>
                        We go beyond testing, inspecting and certifying products; we are a Total
