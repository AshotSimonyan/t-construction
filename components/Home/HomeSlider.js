...
const slideData = [
  ...
  {
    title: 'Ձեր վստահելի գործընկերը շինարարության մեջ',
    description:
  ...
  {
    title: 'Նորարար լուծումներ, կայուն շինարարություն',
    description:
  ...
  {
    title: 'Բարձրորակ Շինարարություն՝ Ձեր Հավակնոտ Նախագծերի Համար',
    description:
