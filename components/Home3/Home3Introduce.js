          ...
          <div className='fn_cs_introduce'>
            ...
            <div className='content_holder'>
              <div className='title_holder'>
                ...
                <h3>Our Company</h3>
                <p>
                  For over 47 years, the Industify family has been building relationships and
                  projects that last. We build safe environments and eco-friendly solutions in the
                  communities in which we work. Most importantly, we build strong relationships that
                  allow us to build anything, anywhere. No matter the job, we go beyond building.
                </p>
              </div>
