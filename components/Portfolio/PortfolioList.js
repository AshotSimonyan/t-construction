          ...
          <div className='container'>
            <div className='filter'>
              ...
              <ul className={isDropdown ? 'fn_filter opened' : 'fn_filter'} onClick={handleClick}>
                ...
                <li>
                  <a
                    className={filterKey === 'one' ? 'active' : ''}
                    onClick={handleFilterKeyChange('one')}
                  >
                    Aerospace
                  </a>
                </li>
                <li>
                  <a
                    className={filterKey === 'two' ? 'active' : ''}
                    onClick={handleFilterKeyChange('two')}
                  >
                    Car Industry
                  </a>
                </li>
                <li>
                  <a
                    className={filterKey === 'three' ? 'active' : ''}
                    onClick={handleFilterKeyChange('three')}
                  >
                    Construction
                  </a>
                </li>
                <li>
                  <a
                    className={filterKey === 'four' ? 'active' : ''}
                    onClick={handleFilterKeyChange('four')}
                  >
                    Gas and Oil
                  </a>
                </li>
                <li>
                  <a
                    className={filterKey === 'five' ? 'active' : ''}
                    onClick={handleFilterKeyChange('five')}
                  >
                    Machinery
                  </a>
                </li>
